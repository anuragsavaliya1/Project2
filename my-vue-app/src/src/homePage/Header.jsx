...
export default function Header({ activeTab, setActiveTab }) {
  return (
    <div>
      <div className="bg-[#ffffff] h-15 drop-shadow-md content-center px-2 flex justify-between items-center overflow-hidden top-0 sticky">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden sm:flex space-x-3 lg:mr-30 md:mr-10">
            <MainIcons activeTab={activeTab} setActiveTab={setActiveTab} />
            <SearchBar />
