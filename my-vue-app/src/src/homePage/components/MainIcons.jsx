...
import { home, reels } from "../../redux/pageSlice/pageSlice";
export default function MainIcons() {
  ...
  return (
    <div className="flex space-x-3 justify-center items-center place-items-baseline mt-1.5">
      <div className="h-10 w-10 place-items-center" onClick={() => dispatch(home())}>
      ...
      <div className="h-10 w-10 place-items-center" onClick={() => dispatch(reels())}>
